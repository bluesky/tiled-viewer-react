...
export default function OpenTiledRow({userInputApiKey, setIsViewerOpen, buttonModeText, selectedData, handleInputChange, userInputReverseSort, handleReverseSortChange}: OpenTiledRowProps) {
