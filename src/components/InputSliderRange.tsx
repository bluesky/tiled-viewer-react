...
export default function InputSliderRange({
  ...
  ...props
    ...
    const calculatePositionStyleThumbInput = (value: number) => {
        const positionStyle = `calc(${((value - min) / (max - min)) * 100}% + ${(-((value - min) / (max - min))*thumbWidth)}px)`
        return positionStyle;
    };
            ...
            <div className="relative flex-grow">
                <div className="w-full absolute top-0 left-0">
                    ...
                    <div className="flex-grow flex items-center relative">
                        ...
                        />
                        {/** Thumb Input Number */}
                        <div className="absolute z-0 -top-8 w-12 h-24" style={{left: calculatePositionStyleThumbInput(value[0])}}>
                ...
                <div className="w-full absolute top-0 left-0">
                    <div className="flex-grow flex items-center relative">
                        ...
                        />
                            ...
                            `}</style>
                        {/** Thumb Input Number */}
                        <div className="absolute z-0 -top-8 w-12 h-24" style={{left: calculatePositionStyleThumbInput(value[1])}}>
                            <div className="relative ">
                                <div className="absolute w-[0] h-4 top-1 bg-gray-400"></div>
                                <div className="absolute -translate-x-1/2 left-2 -y-translate-full -top-0">
                                    <input 
